...
[Mastering the .dockerignore File: Boosting Docker Build Efficiency](https://medium.com/@bounouh.fedi/mastering-the-dockerignore-file-boosting-docker-build-efficiency-398719f4a0e1)
...
{
 {
    ...
    "template": {
        "id": "uuid-123", //template
        "title": "PROBLEMA GRAVE",
        "subject": "INSTABILIDADE ",
        "body": "Olá {{destinatário}}, tudo bem ? venho por meio desta informar que estamos passando por instabilidades, retornaremos semana que vem\n\nAtt, {{remetente}}",
        "createdAt": "2026-02-28T15:00:04.192Z",
        "authorId": "uuid-123" //usuário
    }
}
}
```
...
{
  "templateId": "uuid-456", //template
  "recipientIds": ["uuid-789", "uuid-790"] //usuários
}
```
...
```json
{
    ...
    "result": {
        "emails": [
            {
                "id": "bdd362c9-45bc-4c10-b346-a83fd0588958",
                "name": "joao",
                "email": "joao@gmail.com",
                "body": "Olá Joao, tudo bem? venho por meio desta informar que estamos passando por instabilidades, retornaremos semana que vem\n\nAtt, lucas"
            },
            {
                "id": "f8dd8666-b28b-474c-9c92-fec00f441ea1",
                "name": "fulano",
                "email": "fulano@teste.com",
                "body": "Olá Felipe, tudo bem? venho por meio desta informar que estamos passando por instabilidades, retornaremos semana que vem\n\nAtt, lucas"
            }
        ]
    }
}
//as variaveis irão ser preenchidas no momento do envio dos emails 
```
